...
function tabulatorInit() {
    ...
    table = new Tabulator("#dataGrid", {
        ...
        columns: [
            {title: "Conclusion", field: "conclusion", visible: true, editor:"list", responsive:0, minWidth:50, width:50, widthGrow:1, download:true,
                editorParams:{
            ...
            {title: "Comment", field: "comment", visible: true, editor: "textarea", formatter:"textarea", headerMenu: headerMenu, tooltip: true, download:true, responsive:cooddyResults.reporter != "secb" ? 4 : 0 , minWidth:100, widthGrow:2},
